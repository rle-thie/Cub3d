...
{
	if (data->map[(int)(data->player->x + (data->player->dir_x * data->move_speed))][(int)data->player->y] != '1')
	{
		data->player->x += data->player->dir_x * data->move_speed;
		data->player->change = 1;
	}
	if (data->map[(int)data->player->x][(int)(data->player->y + data->player->dir_y * data->move_speed)] != '1')
	{
...
{
	if (data->map[(int)(data->player->x + (data->player->dir_y * data->move_speed))][(int)data->player->y] != '1')
	{
		data->player->x += data->player->dir_y * data->move_speed;
		data->player->change = 1;
	}
	if (data->map[(int)data->player->x][(int)(data->player->y - (data->player->dir_x * data->move_speed))] != '1')
	{
